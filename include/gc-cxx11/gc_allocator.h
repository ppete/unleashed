...
//
// This file was modified to be compatible with C++11 allocators.
...
#ifndef CXX11_GC_ALLOCATOR_H

#define CXX11_GC_ALLOCATOR_H
...
public:
  ...
  gc_allocator_cxx11()  {}
  gc_allocator_cxx11(const gc_allocator_cxx11&) throw() {}
# if !(GC_NO_MEMBER_TEMPLATES || 0 < _MSC_VER && _MSC_VER <= 1200)
  // MSVC++ 6.0 do not support member templates
  template <class GC_Tp1> gc_allocator_cxx11(const gc_allocator_cxx11<GC_Tp1>&) throw() {}
# endif
  ~gc_allocator_cxx11() throw() {}
  ...
  template <class... Args>
  void construct(pointer __p, Args&&... args) { new(__p) GC_Tp(args...); }
